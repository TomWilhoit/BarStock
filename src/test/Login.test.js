...
describe('Login', () => {
  ...
  beforeEach(() => {
    ...
    it('should update the state of userNameValue and passwordValue on change', () => {
      ...
      wrapper.find('.username-input').simulate('change', {'target':{name:'userNameValue',value:'Taylor'}});console.warn();
      
      wrapper.find('.password-input').simulate('change', {'target':{name:'passwordValue',value:'abc'}});
